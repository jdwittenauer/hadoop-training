...
public class InventoryDAO {
	...
	public Result checkoutWithIncrement(String stockId, String cartId,
			long amount) throws Exception {
		// TODO 1 finish checkout code
		Result result = null;
		System.out.println("--checkout Inventory stockId " + stockId
				+ " cartId " + cartId + " quantity " + amount);
		...
		if (currentQuantity - amount < 0)
		    ...
		    inc.addColumn(InventoryDAO.STOCK_CF, InventoryDAO.QUANTITY_COL, amount * -1);
		    inc.addColumn(InventoryDAO.STOCK_CF, userCol,amount);

...
//			"yyyyMMdd");
	...
	public static void scanWithoutFilters(TradeDAOFlat tradeDao)
			throws Exception {
	...
	public static void scanValueFilter(TradeDAOFlat tradeDao) throws Exception {
		System.out
				.println(" Filter trades any column Value Greater or Equal 8327 Long ");
	...
	public static void scanColumnFilter(TradeDAOFlat tradeDao) throws Exception {
		...
		SingleColumnValueFilter filter = new SingleColumnValueFilter(
				TradeDAOFlat.volumeCF, // price CF
				Bytes.toBytes("11"), // 11 column
				CompareFilter.CompareOp.LESS, new BinaryComparator(
						Bytes.toBytes(8327l)));

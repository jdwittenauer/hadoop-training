...
public class FilterTradesTall {
	...
	public static List<Trade> scanWithoutFilters(TradeDAOTall tradeDao)
			throws Exception {
	...
	public static List<Trade> scanRowFilter(TradeDAOTall tradeDao, String filterString)
			throws IOException {
		// TODO 2 finish code
		// create a RowFilter with a CompareFilter.CompareOp.EQUAL and
		// SubstringComparator
		// to filter the input filterString
		Filter filter = new RowFilter(CompareFilter.CompareOp.EQUAL,
				new SubstringComparator(filterString));

...
java -cp `hbase classpath`:./lab-exercises-shopping3-solution-1.0.jar shopping.ShoppingCartApp setup


java -cp `hbase classpath`:./lab-exercises-shopping3-solution-1.0.jar shopping.ShoppingCartApp checkout Mike

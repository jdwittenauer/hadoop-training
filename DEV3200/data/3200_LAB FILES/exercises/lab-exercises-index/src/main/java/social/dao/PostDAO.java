...
public class PostDAO {
  ...
  //  public static final String userdirectory = System.getProperty("user.home");
    ...
    private static Put makePut(Post post) {
		...
		// TODO 4 add to the put
		// the comment column family COMMENT_CF
		// the comment.id in Bytes (this is the column qualifier)
		// the comment.text in Bytes
		// p.add( ) ;
        return p;
    }
    ...
    public List<Comment> getComments(String postId) throws IOException {
		...
		// TODO 4 get the FamilyMap from the result for the COMMENT_CF
		// column family
		// Result getFamilyMap(CF) Returns a NavigableMap<byte[], byte[]> of the
		// form: Map<qualifier,value>
		NavigableMap<byte[], byte[]> map = null; // TODO exercise 4

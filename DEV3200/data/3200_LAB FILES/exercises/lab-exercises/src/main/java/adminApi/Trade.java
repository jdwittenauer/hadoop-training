...
/**
 * The Trade class represents trade events on a stock exchange. A Trade instance
 * is defined by date, ticker symbol, price and volume.
 */
public class Trade {
	...
	/**
	 * constructor for a Trade object This implementation explicitly sets the
	 * tradeTime to a given value.
	 * 
	 * @param tradeSymbol
	 *            stock symbol, ex: "GOOG"
	 * @param tradePrice
	 *            per-share price
	 * @param tradeVolume
	...
	/**
	 * constructor for a Trade object This implementation sets the tradeTime to
	 * the current time.
	 * 
	 * @param tradeSymbol
	 *            stock symbol, ex: "GOOG"
	...
	public String toString() {
		return tradeSymbol + ": " + tradeVolume + " shares at "
				+ CURRENCY.getSymbol() + String.format("%.2f", tradePrice)
